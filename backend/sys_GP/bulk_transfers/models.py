...
class BulkTransferJob(models.Model):
    ...
    reussi_count = models.IntegerField(default=0)
    echoue_count = models.IntegerField(default=0)
    message_execution = models.TextField(default="Traitement en cours...", blank=True, null=True)
