...
from .views import BulkTransferUploadAPIView, BulkTransferStatusAPIView, ExportBulkTransferCSV, BulkJobHistoryAPIView
...
urlpatterns = [
    ...
    path('bulk/history/', BulkJobHistoryAPIView.as_view(), name='bulk-job-history'),
