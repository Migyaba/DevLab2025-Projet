...
from .serializers import BulkTransferUploadSerializer, BulkTransferJobSerializer, TransferDetailSerializer, BulkJobRecapSerializer
...
class BulkJobHistoryAPIView(generics.ListAPIView):
    """
    API pour lister l'historique de tous les lots de transfert.
    Affiche un récapitulatif simple.
    """
    queryset = BulkTransferJob.objects.all().order_by('-created_at') # Du plus récent au plus ancien
    serializer_class = BulkJobRecapSerializer